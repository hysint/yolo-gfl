...
def process_image(model, image_path, model_name, conf_threshold):
...
def main():
    ...
    base_dir = os.path.join("demo/output/images", f"batch_{timestamp}")
    ...
    for img_path in image_paths:
        ...
        for model_name, model in models.items():
            annotated, stat = process_image(model, img_path, model_name, CONF_THRESHOLD)
