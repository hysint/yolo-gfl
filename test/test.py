...
def visualize_performance_metrics(results, output_dir="runs/performance_analysis"):
    ...
    avg_times_ms = [result['avg_inference_time'] * 1000 for result in results]
    std_times_ms = [result['std_inference_time'] * 1000 for result in results]
    ...
    inference_time_data = [np.array(result['inference_times']) * 1000 for result in results]
    ...
    fps_normalized = np.array(fps_values) * 10 
...
def evaluate_model(model_path: str, data_path: str, run_name: str, test_images_dir: str):
    ...
    print(f"\nPerformance Analysis with Inference Saving")
    avg_inference_time, fps, inference_times = calculate_performance(
...
def main():
    ...
    test_images_dir = r"dataset/HOME-FIRE/test/images"
    models_to_evaluate = [
        {
            "model_path": r'main/yolov12/results/weights/best.pt',
            "run_name": 'YOLOv12',
        },
        {
            "model_path": r'main/yolo-gfl/results/weights/best.pt',
            "run_name": 'YOLO-GFL',
        },
    ]
